...
@Composable
fun ClientAddressUpdateContent(
    padding: PaddingValues, vm: ClientAddressUpdateViewModel = hiltViewModel()
) {
        ...
        Card(
            ...
            Column(
                ...
                DefaultButton(modifier = Modifier
                    ...
                    text = R.string.update_address,
                    onClick = { vm.validateForm(ctx) { isValid -> if (isValid) vm.updateAddress() } })
            }
        }
    }
}